           ...
           <input type="hidden" name="monthWaterId" value="${waMonthWaterData.monthWaterId}" id="monthWaterId"></input>
            <table class="hgtable">
               ...
               <%-- <tr>
                ...
                <tr>
                     <td>实际用水量:</td>
                     <td><input type="text" style="width: 170px" name="actMonthWater" id="actMonthWater" value="${waMonthWaterData.actMonthWater}" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" ></input></td>
                 </tr>
             <%--   <tr>
                    <td>收费标准:</td>
